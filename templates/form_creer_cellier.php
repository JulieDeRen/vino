<div class="flex flex-col lg:flex-row h-screen items-center">
  <div class="bg-gray-900 lg:w-1/2">
    <div class="flex flex-col justify-center lg:h-screen">
      <img src="{{url('/img/form/form_wine.jpg')}}" alt="" class="h-full w-full object-cover">
    </div>
  </div>
  <div class="bg-white lg:w-1/2">
    <div class="container mx-auto py-16 px-8">
      <h2 class="text-4xl font-bold mb-8">Créer un Cellier</h2>
      <p class="text-gray-700 mb-4">Veuillez remplir le formulaire suivant pour créer un nouveau cellier.</p>
