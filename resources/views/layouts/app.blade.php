    ...
    <div id="app">
        <nav class="bg-gray-50 shadow-sm px-4 py-5">
            <div class="flex items-center justify-between mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl">
                ...
                <div class="lg:hidden">
                    <button aria-label="Open Menu" title="Open Menu" class="p-2 -mr-1 transition duration-200 rounded focus:outline-none focus:shadow-outline hover:bg-accent_wine-50 focus:bg-deep-purple-50" @click="isMenuOpen = true">
