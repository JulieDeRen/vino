...
<div class="overflow-hidden transition-shadow duration-300 max-w-full mx-auto bg-white rounded  max-h-[550px]">
  ...
  <div class="py-5">
    ...
    <a href="/" aria-label="Article" class="inline-block mb-3 text-black transition-colors duration-200 hover:text-deep-purple-accent-700"><p class="sm:text-2xl text-xl font-bold leading-6">André Rohrer Stein Riesling</p></a>
